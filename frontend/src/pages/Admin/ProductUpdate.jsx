  ...
  useEffect(() => {
    if (productData && productData._id) {
      ...
      if (productData.shippingDetails)
        setShippingDetails(structuredClone(productData.shippingDetails));
      if (productData.keyFeatures)
        setKeyFeatures(structuredClone(productData.keyFeatures));
      if (productData.specifications)
        setSpecifications(structuredClone(productData.specifications));

      if (productData.hasVariants !== undefined)
        setHasVariants(productData.hasVariants);
      if (productData.variants && productData.variants.length > 0)
        setVariants(structuredClone(productData.variants));
    }
  }, [productData]);
